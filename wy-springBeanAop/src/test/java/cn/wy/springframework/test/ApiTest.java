...
import cn.wy.springframework.aop.framework.Cglib2AopProxy;
import cn.wy.springframework.aop.framework.JdkDynamicAopProxy;
...
import cn.wy.springframework.test.bean.UserServiceBeforeAdvice;
import cn.wy.springframework.test.bean.UserServiceInterceptor;
...
public class ApiTest {
    ...
    public void init() {
        ...
        advisedSupport.setMethodMatcher(new AspectJExpressionPointcut("execution(* cn.wy.springframework.test.bean.IUserService.*(..))"));
    }
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* cn.wy.springframework.test.bean.IUserService.*(..))");
    ...
    public void test_proxy_method() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* cn.wy.springframework.test.bean.IUserService.*(..))");
